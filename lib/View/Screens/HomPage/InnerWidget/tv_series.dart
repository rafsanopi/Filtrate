        ...
        Obx(() {
          switch (homeController.rxRequestStatus.value) {
            ...
            case Status.completed:
              return homeController.tvSeriesList.isNotEmpty &&
                      homeController.tvSeriesList.length >= 5
                  ? SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        5,
                        (index) {
                          var data = homeController.tvSeriesList[index];
                          ...
                          return MovieDesignCard(
                              ...
                              genre: homeController.getGenreNames(
                                  ...
                                  gerne: homeController.tvSeriesGerne));
                        },
                      )),
                    )
                  : const Center(
